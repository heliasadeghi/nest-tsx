...
const PosterCard: React.FC = () => {
  return (
    // postcard section
    <>
      <div className="container h-auto sm:h-[600px]  sm:px-10 sm:mx-auto flex sm:justify-between sm:flex-row flex-col sm:items-center ">
        <div className="order-2 sm:order-1 text-center sm:text-start mt-10 sm:mt-0 ">
          <h2 className="text-[35px] text-center sm:text-[90px] font-extrabold text-[var(--bg-gray-03)] leading-normal sm:leading-[100px] mb-2 capitalize sm:text-start  sm:normal-case">
            More than just <br /> shorter links
          </h2>
          <p className="px-4 sm:px-0 text-[18px] sm:text-[24px] capitalize text-[var(--bg-gray-02)] font-medium ">
            bulid your brand's recognition and get detailed <br /> insights on
            how your links are performing
          </p>
          <button className="my-12 capitalize font-bold sm:font-medium text-white bg-[var(--bg-cyan)] p-3 px-9 rounded-full text-[18px] sm:text-[24px] hover:bg-[var(--bg-cyan-hover)] transition-all ease-linear cursor-pointer ">
            get started
          </button>
        </div>
        <div className="w-full sm:w-auto relative sm:order-2 order-1 sm:scale-100 sm:h-auto h-[300px] ">
          {/* start svg */}
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="733"
            height="482"
            className=" absolute sm:top-[calc(50%_-_300px)] sm:left-[calc(50%_-_400px)] sm:scale-100 scale-[0.6] left-[-120px] top-[-80px]"
          >
            <defs>
