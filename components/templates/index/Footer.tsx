...
function Footer({}: FooterProps) {
  const [possibilities, setPossibilities] = useState<Possibility[]>([
    {
      id: 1,
      items: [
        { id: 11, name: "link shortening" },
        { id: 12, name: "branded links" },
        { id: 13, name: "analytics" }
      ],
      title: "features"
    },
    {
  ...
  return (
    <div className="w-full sm:h-[400px] bg-[var(--bg-gray-04)] flex flex-col sm:flex-row pt-8 sm:pt-20 gap-5 sm:gap-0">
      <div className="sm:w-4/12 flex flex-row  gap-5 ">
        <h2 className="capitalize text-[32px] text-white font-extrabold mx-20 ">
          Shortly
        </h2>
      </div>
      ...
      <div className="w-full sm:w-3/12 flex flex-row  gap-5  hover:text-[var(--bg-cyan)] transition-all ease-linear duration-100 cursor-pointer text-[20px] justify-center sm:justify-start mt-5 sm:mt-0">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24">
          <path
            className="hover:fill-[var(--bg-cyan)] transition-all ease-linear duration-100 cursor-pointer "
            fill="#FFF"
